package com.ctrip.gs.favorite.db;
 ...
 * <pre>
 * {@code
 *    <bean id="dataSource" class="com.ctrip.gs.favorite.db.MasterSlaveRoutingDataSource">
...
public class MasterSlaveRoutingDataSource extends AbstractRoutingDataSource implements Serializable  {
    ...
    /**
     * Parse the data source string. Each line should be like this:
     *   analytics: analytics_master, analytics_slave1, analytics_slave
     * The value before ":" is the name of the database, the value is a list of data source keys. 
     * The first data source should be the master, and the rest should be slaves.
     * 
     ...
     * @param isMaster      Whether it's master or slave
     */
    ...
    protected Object determineCurrentLookupKey() {
        ...
        if (dss == null || dss.isEmpty()) {
            ...
            // TODO: choose slave randomly from multi-datasources
            return dss.get(1);
        }
    }
