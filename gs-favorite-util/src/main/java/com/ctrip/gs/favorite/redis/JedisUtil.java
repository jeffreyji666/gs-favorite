package com.ctrip.gs.favorite.redis;
...
/**
 * A set of utility methods that makes it more convenient to work with <a
 * href="https://github.com/xetorthio/jedis">Jedis</a>.
 * 
...
public final class JedisUtil {
	 ...
	 * 
	 * @param pool
	 *            The {@code JedisPool} of connections for which this extra
	 ...
	 * Jedis connections. This method will be deprecated once Jedis incomorates
	 * Java 7's automatic resource management.
	 * 
	 * Calling this method yields a {@link LinkedCallbackBuilder}, which opens
	 * up to two more method calls in the DSL named
	 ...
	 * 
	 * @param <T>
	 *            The parameterizing type for the subsequent
	 *            {@code _do(F<Jedis, T>...)} method call in the DSL call-chain.
	 * @param pool
	 *            The pool of {@code Jedis} connections to be utilized during
	 *            the callback step.
	 * @throws JedisConnectionException
	 *             if an error occurred while sending or receiving data from a
	 *             {@code Jedis} connection in the {@code JedisPool} of
	 *             connections.
